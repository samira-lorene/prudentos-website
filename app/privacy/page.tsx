...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-3xl mt-16 md:mt-4 mx-auto p-6 font-light text-gray-800">
      <h1 className="text-2xl font-bold mb-4">
        Samira Prudentos Privacy Policy
      </h1>
      ...
      <p className="mb-4">
        ...
        Shopify, see https://www.shopify.com/legal/cookies.
      </p>
      ...
      <p>
        ...
        <a href="mailto:samira.prudentos@web.de" className="text-blue-500">
          samira.prudentos@web.de
        </a>{" "}
        or contact us at Gethsemanestraße 7, Berlin, Berlin, 10437, Germany.
      </p>
    </div>
  );
}
